...
public class Filter4Handler extends DisruptorEventHandler{
    ...
    public void onEvent(DisruptorEvent carbonDisruptorEvent, long l, boolean b) throws Exception {
        ...
        if(msg.isFinalized()) {
           ...
           // System.out.println("===========4444== Finalize========" + msg.getName() + "======" + msg.getAge()+ "===== finalized count ===" + msg.getConfigContext().getFinalizeRoutes().size() + "=== missed count ===" + msg.getConfigContext().getMissCount());
        }
